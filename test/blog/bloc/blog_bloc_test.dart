...
//   blocTest('loaded posts failed',
//       build: () => bloc,
//       act: (bloc) => bloc.add(GetPostsForBlogEvent()),
//       expect: () =>
//           [BlogLoadingState(), BlogErrorState('Ups something went wrong ...')]);

//   blocTest('loaded posts faile 2 d',
//       build: () => bloc,
//       act: (bloc) => bloc.add(GetPostsForBlogEvent()),
//       expect: () => [BlogLoadingState(), BlogLoadedState(tPosts)]);

//   // group('BlogBloc', () {
//   //   blocTest<BlogBloc, BlogState>(
//   //     'debería emitir [PostLoading, PostLoaded] cuando los posts son obtenidos exitosamente',
//   //     build: () {
...
import 'blog_bloc_test.mocks.dart'; // Generado automáticamente por mockito
